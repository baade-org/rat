...
public class IDParser extends AbstractParser<Field, TableColumn>  implements IParser<Field, TableColumn> {

    @Override
    public TableColumn parse(Field field, Class<? extends TableColumn> clazzd) {
        ...
        TableColumn tableColumn = new TableColumn(name, typeValue, typeStr, length, decimalsLength, nullable, true, comment, defaultValue, fieldName);
